...
<br />
<div align="center">
<h3 align="center">MedIOT Server</h3>

  <p align="center">
  A server for receiving sensor data and saving them in firebase
    <br />
    <a href="https://github.com/elfatairy/medIotServer/issues/new?labels=bug&template=bug-report---.md">Report Bug</a>
    &middot;
    <a href="https://github.com/elfatairy/medIotServer/issues/new?labels=enhancement&template=feature-request---.md">Request Feature</a>
  </p>
</div>
...
1. Clone the repo
   ```sh
   git clone https://github.com/elfatairy/medIotServer.git
   cd medIotServer
   ```
...
4. Run the application from the src folder
   ```sh
   npm start
   ```
...
5. The server will start on the port specified in the script file
...
Project Link: [https://github.com/elfatairy/medIotServer](https://github.com/elfatairy/medIotServer)
...
[contributors-shield]: https://img.shields.io/github/contributors/elfatairy/medIotServer.svg?style=for-the-badge
[contributors-url]: https://github.com/elfatairy/medIotServer/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/elfatairy/medIotServer.svg?style=for-the-badge
[forks-url]: https://github.com/elfatairy/medIotServer/network/members
[stars-shield]: https://img.shields.io/github/stars/elfatairy/medIotServer.svg?style=for-the-badge
[stars-url]: https://github.com/elfatairy/medIotServer/stargazers
[issues-shield]: https://img.shields.io/github/issues/elfatairy/medIotServer.svg?style=for-the-badge
[issues-url]: https://github.com/elfatairy/medIotServer/issues
[license-shield]: https://img.shields.io/github/license/elfatairy/medIotServer.svg?style=for-the-badge
[license-url]: https://github.com/elfatairy/medIotServer/blob/main/LICENSE
